...
public class MainSettingsActivity extends AppCompatActivity {
    ...
    private void mainSettingsOnClickEvents() {
        ...
        main_settings_rsearch_lay.setOnClickListener(v -> {
            analyticDBHelper.deleteAllRecentPlaces();
            Snackbar.make(v, "Recent Searches Cleared.....", Snackbar.LENGTH_SHORT).show();
        });

        main_settings_rplaces_lay.setOnClickListener(v -> {
            recentPlaceDBHelper.deleteRecentPlace();
            Snackbar.make(v, "All Recent Places cleared..... :)", Snackbar.LENGTH_SHORT).show();
        });
